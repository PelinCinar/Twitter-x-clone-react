...
export default function More() {
  return (
    <Popover className="relative">
      <PopoverButton className="py-[1px] block group outline-none ">
        <button>
          <div
            className={
      ...
      <PopoverPanel className="w-[318px] max-h-[475px]  absolute bottom-0 left-0 bg-black shadow-box rounded-xl">
        <button
          className={
        ...
        >
          ...
          <div className="pr-4 text-xl font-bold">Onaylı Kuruluşlar</div>
        </button>
        <button
          className={
            "px-4 h-14 w-full transition-colors inline-flex items-center gap-5 hover:bg-[#eff3f41a]"
